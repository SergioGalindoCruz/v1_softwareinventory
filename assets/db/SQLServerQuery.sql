...
create table rol (idrol int primary key IDENTITY(1,1), rol varchar(20))
...
create table categorias (idcategoria int primary key IDENTITY(1,1), nombre varchar (100))
...
create table productos (idproducto int primary key IDENTITY(1,1), codigobarras varchar(100), descripcion varchar (200), precioventa decimal(10,2), preciocosto decimal(10,2), stock int, idcategoria int, idproveedor int)
...
CREATE TABLE detalle_temp (
  correlativo int NOT NULL IDENTITY(17,1),
...
CREATE TABLE factura (
  nofactura int NOT NULL IDENTITY(1,1),
